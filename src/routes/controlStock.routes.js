...
// Admin ve cualquier sesión; empleado solo la sesión actual (validado en controller)
router.get('/sesiones/:id/movimientos', controlStockController.getMovimientosSesion);
router.post(
